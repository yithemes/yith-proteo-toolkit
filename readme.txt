...
== Changelog ==
=  1.3.2 - Released on 9 Sep 2026 =

* Fix: setup wizard capability check no longer blocks wp-admin for non-administrator users
...
* Fix: missing parent theme version in generated child theme functions.php file

=  1.2.0 - Released on 04 November 2021 =

* Fix: widget import errors
* Fix: backend script warnings
* Dev: support for third party skins
